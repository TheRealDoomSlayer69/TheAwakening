...
public class BaseArmorMaterial<Ingredient extends net.minecraft.world.item.crafting.Ingredient, SoundEvent extends net.minecraft.sounds.SoundEvent> implements ArmorMaterial {
    ...
    public BaseArmorMaterial(int enchantability, int[] durability, int[]  damageReduction,
    		float knockbackResistance, float toughness,  String string, SoundEvent equipSound,
