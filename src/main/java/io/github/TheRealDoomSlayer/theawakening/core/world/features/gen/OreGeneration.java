...
public static void generateOres(final BiomeLoadingEvent event) {
    spawnOreInSpecificBiome(Biomes.NETHER_WASTES, OreType.PYRIUM_ORE, event, LevelStem.NETHER.toString());
    spawnOreInSpecificBiome(Biomes.WARPED_FOREST, OreType.PYRIUM_ORE, event, LevelStem.NETHER.toString());
    spawnOreInSpecificBiome(Biomes.CRIMSON_FOREST, OreType.PYRIUM_ORE, event, LevelStem.NETHER.toString());
    spawnOreInSpecificBiome(Biomes.SOUL_SAND_VALLEY, OreType.PYRIUM_ORE, event, LevelStem.NETHER.toString());
